    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700 pb-12">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <Button
            href="/dashboard/admin/lost_and_found/report"
            icon={PlusCircle}
          >
            Report Item
          </Button>
        ...
        <div className="flex flex-wrap gap-2">
          {CATEGORIES.map(cat => (
            <button
              ...
              className={` px-4 py-2 rounded-md text-[11px] font-semibold uppercase tracking-widest transition-all ${activeFilter === cat ? 'bg-[#1241a1]/10 text-[#1241a1]' : 'bg-[#1a1d23] text-[#8a8f98] hover:bg-[#1a1d23] hover:bg-[#2a2d33]'}`}
            >
              {cat}
            </button>
          ))}
