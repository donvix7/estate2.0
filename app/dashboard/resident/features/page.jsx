...
import { Bell, History, Settings, TriangleAlert, UserPlus, Wallet, FileText, CreditCard, Receipt, CalendarRange, PartyPopper, FileBadge2, UsersRound, UserCircle, ShieldCheck, HardHat } from 'lucide-react'
...
const page = () => {
  ...
  const accessTabs = [
    ...
    const paymentTabs = [
    { name: 'Fund wallet', icon: Wallet, href: '/dashboard/resident/fund-wallet' },
    { name: 'Dues', icon: FileText, href: '/dashboard/resident/dues' },
    { name: 'Other Payments', icon: CreditCard, href: '/dashboard/resident/other-payments' },
    { name: 'Invoice', icon: Receipt, href: '/dashboard/resident/invoice' },
 ]
  return (
    <div className=" ">
          <div className="block md:hidden text-sm p-2 max-w-md mx-auto">
            <div className="text-lg font-bold mb-4">Access Features</div>
          ...
          <div className="block md:hidden text-sm p-2 max-w-md mx-auto">
            <div className="text-lg font-bold mb-4">Payment Features</div>
              <div className="grid grid-cols-4 gap-2 sm:gap-4 mb-8 md:hidden">
          ...
          <div className="hidden md:block text-sm p-4 max-w-7xl mx-auto mt-6">
            <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-white font-heading">Access Features</h2>
            ...
            <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-white font-heading">Payment Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-12">
              {paymentTabs.map((tab, index) => (
                <Link href={tab.href} key={index} className="group">
                  <TechCard className="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors h-full flex flex-col justify-center ">
