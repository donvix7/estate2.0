    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700 pb-12">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="bg-amber-700 text-white px-5 py-2.5 rounded-md text-[13px] font-semibold uppercase tracking-widest flex items-center gap-2 hover:brightness-110 transition-all shadow-lg shadow-[#1241a1]/20 whitespace-nowrap"
          >
            <PlusCircle size={16} />
            Report Item
          </Link>
      ...
      {items.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center gap-4  bg-[#818b94]/10">
          <div className="size-16  rounded-2xl flex items-center justify-center text-amber-700">
            <SearchX size={32} />
          </div>
