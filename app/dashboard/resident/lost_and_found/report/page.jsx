...
export default function ReportItemPage() {
 ...
 {/* Lost / Found toggle */}
 <div className="p-1.5 bg-[#1a1d23] bg-[#1a1d23]/50 rounded-xl flex w-full sm:w-64">
 {['lost', 'found'].map(type => (
 <button
 key={type}
 type="button"
 ...
 <label className="block text-sm font-bold text-white ">Item Name</label>
 <input
 name="name"
 type="text"
 value={form.name}
 ...
 required
 className="w-full bg-[#1a1d23] rounded-xl p-4 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all placeholder:text-[#8a8f98] placeholder:text-[#8a8f98] text-sm text-white"
 />
 </div>
 ...
 value={form.category}
 onChange={handleChange}
 className="w-full bg-[#1a1d23] rounded-xl p-4 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all appearance-none cursor-pointer text-sm text-white"
 >
 ...
 {/* Date */}
 <div className="space-y-2">
 <label className="block text-sm font-bold text-white ">Date Observed</label>
 <input
 name="date"
 type="date"
 value={form.date}
 onChange={handleChange}
 className="w-full bg-[#1a1d23] rounded-xl p-4 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all text-sm text-white"
 />
 </div>

 {/* Location */}
 <div className="sm:col-span-2 space-y-2">
 <label className="block text-sm font-bold text-white ">Location</label>
 ...
 className="w-full bg-[#1a1d23] rounded-xl p-4 pl-12 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all placeholder:text-[#8a8f98] placeholder:text-[#8a8f98] text-sm text-white"
 />
 </div>
 </div>
 ...
 className="w-full bg-[#1a1d23] rounded-xl p-4 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all resize-none placeholder:text-[#8a8f98] placeholder:text-[#8a8f98] text-sm text-white"
 />
 </div>
 ...
 className={`bg-[#1a1d23] bg-[#0d0f13]/40 rounded-xl p-8 flex flex-col items-center justify-center min-h-[260px] text-center cursor-pointer transition-all group ${
 dragging
 ? 'bg-[#1241a1]/5'
 : 'hover:bg-[#1241a1]/5'
 }`}
 ...
 <h4 className="text-lg font-bold mb-1 text-white text-white">Upload Photos</h4>
 <p className="text-[#8a8f98] text-[#8a8f98] text-sm max-w-[240px] leading-relaxed">
 ...
 {/* Options */}
 <div className="bg-[#1a1d23] p-6 rounded-xl space-y-5 shadow-sm">
 {/* Privacy toggle */}
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm font-bold text-white text-white">Privacy Protection</p>
 <p className="text-xs text-[#8a8f98]">Hide my contact details initially</p>
 </div>
 <button
 type="button"
 onClick={() => setPrivacy(p => !p)}
 className={`w-12 h-6 rounded-full relative flex items-center px-1 transition-colors ${privacy ? 'bg-[#1241a1]' : 'bg-[#2a2d33]'}`}
 >
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-sm font-bold text-white text-white">Urgent Report</p>
 <p className="text-xs text-[#8a8f98]">Boost visibility for the next 24h</p>
 </div>
 <button
 type="button"
 onClick={() => setUrgent(u => !u)}
 className={`w-12 h-6 rounded-full relative flex items-center px-1 transition-colors ${urgent ? 'bg-[#1241a1]' : 'bg-[#2a2d33]'}`}
 >
 ...
 className="w-full py-5 text-lg rounded-xl font-bold shadow-lg shadow-[#1241a1]/20"
 >
 {submitting ? (
 <>
