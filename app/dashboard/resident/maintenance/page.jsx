        ...
        >
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className="bg-amber-700 hover:brightness-110 text-white px-4 py-2 rounded-md text-sm font-semibold flex items-center gap-2 transition-colors border-none"
            >
