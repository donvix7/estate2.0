...
export default function EmergenciesPage() {
 ...
 {name:"Patrol Beta", status:"On Break • Base", color:"text-[#8a8f98] bg-[#1a1d23] bg-[#1a1d23]800", icon:<Shield className="w-4 h-4" />}
 ]
 useEffect(() => {
 loadEmergencies();
 }, [currentPage]);
 ...
 if (status === 'resolved') return 'bg-white bg-[#1a1d23]900/40 opacity-75';
 if (type?.toLowerCase() === 'fire' || type?.toLowerCase() === 'medical') return 'bg-red-50 bg-red-500/10';
 return 'bg-amber-50 bg-amber-500/10';
 };
 ...
 <p className="text-xs text-[#8a8f98] text-[#8a8f98] mt-1 line-clamp-2">{emg.description}</p>
 ...
 <div className="bg-[#1a1d23] bg-[#1a1d23]/20 p-2.5 rounded-2xl rounded-tl-none text-[11px] font-medium">
 ...
 <div className="bg-[#1241a1] text-white p-2.5 rounded-2xl rounded-tr-none text-[11px] font-medium shadow-md">
 Acknowledged. Redirecting Patrol Beta to support.
 </div>
 </div>
 </div>
 <div className="p-3 bg-[#1a1d23] bg-[#1a1d23]800/80">
 <div className="relative">
 <input 
 type="text" 
 placeholder="Send orders..." 
 className="w-full bg-white bg-[#1a1d23]900 border-none rounded-xl text-xs py-2.5 pl-4 pr-10 focus:ring-2 focus:ring-primary/20 outline-none transition-all" 
 />
