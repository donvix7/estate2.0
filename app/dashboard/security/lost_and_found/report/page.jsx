  ...
  return (
    <div className="max-w-5xl mx-auto pb-12 animate-in fade-in duration-700">
      ...
      <PageHeader
        ...
        iconColor="blue"
      >
        <Link href="/dashboard/resident/lost_and_found" className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-[#1241a1] hover:opacity-70 transition-opacity">
          <ArrowLeft size={14} />
          Back to Lost & Found
        </Link>
      </PageHeader>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 flex flex-col gap-8">
          ...
          {/* Lost / Found toggle */}
          <div className="p-1.5 bg-[#2a2d33] rounded-xl flex w-full sm:w-64">
            {['lost', 'found'].map(type => (
              <button
                key={type}
                type="button"
                ...
                className={`flex-1 py-2.5 px-4 text-center rounded-lg text-sm font-bold transition-all capitalize ${
                  reportType === type
                    ? 'bg-[#1241a1] text-white shadow-sm'
                    : 'text-[#8a8f98] hover:text-[#8a8f98] hover:text-white'
                }`}
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="sm:col-span-2 space-y-2">
              <label className="block text-sm font-bold text-[#8a8f98]">Item Name</label>
              <input
                name="name"
                type="text"
                value={form.name}
                ...
                required
                className="w-full bg-[#1a1d23] rounded-xl p-4 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all placeholder:text-[#8a8f98] text-sm text-white"
              />
            </div>

            {/* Category */}
            <div className="space-y-2">
              <label className="block text-sm font-bold text-[#8a8f98]">Category</label>
              <select
                name="category"
                value={form.category}
                onChange={handleChange}
            ...
            {/* Date */}
            <div className="space-y-2">
              <label className="block text-sm font-bold text-[#8a8f98]">Date Observed</label>
              <input
                name="date"
                type="date"
                value={form.date}
            ...
            {/* Location */}
            <div className="sm:col-span-2 space-y-2">
              <label className="block text-sm font-bold text-[#8a8f98]">Location</label>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#1a1d23] rounded-xl p-4 pl-12 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all placeholder:text-[#8a8f98] text-sm text-white"
                />
              </div>
            </div>
            ...
            {/* Description */}
            <div className="sm:col-span-2 space-y-2">
              <label className="block text-sm font-bold text-[#8a8f98]">Description</label>
              <textarea
                name="description"
                ...
                className="w-full bg-[#1a1d23] rounded-xl p-4 focus:ring-2 focus:ring-[#1241a1] outline-none transition-all resize-none placeholder:text-[#8a8f98] text-sm text-white"
              />
            </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <div className="sticky top-8 flex flex-col gap-6">
            ...
            <div
              ...
              className={`bg-[#1a1d23]/40 rounded-xl p-8 flex flex-col items-center justify-center min-h-[260px] text-center cursor-pointer transition-all group ${
                dragging
                  ? 'bg-[#1241a1]/5'
                  : 'hover:bg-[#1241a1]/5'
              }`}
            >
              ...
              <div className="mt-5 flex gap-2">
                {['JPG', 'PNG', 'MAX 5MB'].map(tag => (
                  <span key={tag} className="px-3 py-1 bg-[#2a2d33] rounded-full text-[10px] font-bold uppercase tracking-widest text-[#8a8f98]">
                    {tag}
                  </span>
                ))}
              </div>
