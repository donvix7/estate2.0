  ...
  return (
    <div className="group bg-slate-100 dark:bg-slate-800/30 p-4 lg:p-6 rounded-md flex flex-col gap-1 lg:gap-2 transition-all">
      <div className="flex items-center justify-between mb-2 lg:mb-4">
        <span className={`size-8 lg:size-12 rounded-md ${bgColor} ${iconColor} flex items-center justify-center transition-colors group-hover:bg-slate-500 group-hover:text-white`}>
          {icon}
        </span>
