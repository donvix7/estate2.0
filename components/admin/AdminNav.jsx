                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-2 text-sm">
                             <span className="text-gray-400">Managed Estate:</span>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-2">
                             <div className="hidden md:block text-right">
                                <div className="text-sm font-bold font-heading text-white leading-none">{userData.name}</div>
                                <div className="text-xs text-gray-500 mt-0.5">{userData.gateStation}</div>
                             </div>
