...
const PAYMENT_TABS = [
    { id: 'card', label: 'Card', icon: <CreditCard className="size-6" /> },
    { id: 'bank', label: 'Bank', icon: <Landmark className="size-6" /> },
    { id: 'digital', label: 'Digital', icon: <Zap className="size-6" /> },
];
            ...
            {activeTab === 'digital' && (
                <form onSubmit={handleSubmit(handleProceed)} className="space-y-4">
                    ...
                    >
                        ...
                        <Lock className="size-4 group-hover:translate-x-1 transition-transform" />
                    </button>
                </form>
            )}
