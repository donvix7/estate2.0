    ...
    <div className="p-4 max-w-2xl mx-auto rounded-xl relative z-40 overflow-hidden text-white w-full group transition-all duration-300 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 shadow-xl shadow-slate-900/50 dark:shadow-slate-950/70 border border-slate-600/50 dark:border-slate-500/30">
      ...
      <div className="relative p-7 sm:p-8 flex flex-col h-full z-10">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="text-[10px] text-amber-300/80 dark:text-amber-200/70 uppercase tracking-widest font-medium block">Digital Card</span>
            </div>
          </div>
        ...
        <div className="mb-10 pl-1">
          <p className="text-amber-200/80 dark:text-amber-300/70 text-xs uppercase tracking-[0.2em] font-semibold mb-2 drop-shadow-sm">Available Balance</p>
          ...
          <div className="mt-2 flex items-center gap-2">
            <div className="w-16 h-1 rounded-full bg-amber-400/30 dark:bg-amber-400/20" />
            <div className="w-8 h-1 rounded-full bg-amber-400/10 dark:bg-amber-400/5" />
          </div>
        </div>
