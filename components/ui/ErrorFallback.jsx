...
export default function ErrorFallback({ error, resetErrorBoundary }) {
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 w-full h-full flex-1">
      <div 
        className=" w-fit bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-xl shadow-red-100/50 dark:shadow-red-900/10 text-center border border-slate-100 dark:border-slate-900"
      >
