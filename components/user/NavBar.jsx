...
const NavBar = ({ 
    ...
    return (
        <nav className="md:block bg-[#1a1d23] backdrop-blur-md text-white text-white sticky top-0 z-50 shadow-sm shadow-none transition-colors">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-2 text-sm">
                             <span className="text-white0 text-[#8a8f98]">Estate:</span>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-2">
                             <div className="hidden md:block text-right">
                                <div className="text-sm font-bold font-heading text-white text-white leading-none">{name}</div>
                                <div className="text-xs text-white0 text-[#8a8f98] mt-0.5">{identifier}</div>
                             </div>
