...
const NavBar = ({ 
    ...
    return (
        <nav className="md:block bg-white/80 dark:bg-gray-900 backdrop-blur-md text-slate-900 dark:text-white sticky top-0 z-50 shadow-sm dark:shadow-none transition-colors">
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="hidden md:flex items-center gap-2 text-sm">
                             <span className="text-slate-500 dark:text-gray-400">Estate:</span>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 pl-2">
                             <div className="hidden md:block text-right">
                                <div className="text-sm font-bold font-heading text-slate-900 dark:text-white leading-none">{name}</div>
                                <div className="text-xs text-slate-500 dark:text-gray-500 mt-0.5">{identifier}</div>
                             </div>
