...
export async function getSubscriptions() {
  const data = await fetchWithAuth(`${db_url}/subscriptions/plans`);
  return data || { docs: [] };
}
export async function fetchMySubscription() {
  const data = await fetchWithAuth(`${db_url}/subscriptions/me`);
  return data || { docs: [] };
}

export async function getFamilyMembers() {
  const data = await fetchWithAuth(`${db_url}/subscriptions/family/members`);
  return data || { docs: [] };
}
